function simulador()
    % Se pone un flag por si se da un erro a la hora de introducir los
    % datos
    flag = 1;
    ...
    nPob = input('Tamaño de la Poblacion para los experimentos: ');
    ...
    probMutacion = input('Probabilidad de Mutacion [0,1]: ');
    ...
    for i=1:NumeroExperi
        ...
        [path,dis] = algoGeneti(poblacion,MatAdyaCiu,probMutacion,ciuIni,nEpoch,tipoCruz,tipoMut);
